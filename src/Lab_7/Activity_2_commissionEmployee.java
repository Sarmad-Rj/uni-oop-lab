...
public class Activity_2_commissionEmployee {
    ...
    public Activity_2_commissionEmployee() {
        FirstName = "Nagina";
        LastName = "Nazar";
        SSN = "S003";
        grossSales = 1234.1;
    ...
    public Activity_2_commissionEmployee(String a, String e, String b, double c, double d) {
        FirstName = a;
        LastName = e;
        SSN = b;
        grossSales = c;
